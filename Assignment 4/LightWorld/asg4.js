...
var FSHADER_SOURCE = `
  ...
  void main() {
    ...
    float specular = pow(max(dot(E,R),0.0),900.0);
    vec3 diffuse = vec3(u_lightColor * gl_FragColor)* nDotL *1.8;
    vec3 ambient = vec3(u_lightColor * gl_FragColor)*0.5;
...
function connectVariablesToGLSL() {
  ...
  if(!u_lightPos) {
    console.log('Failed to create lightPos');
    return false;
  }
...
function addActionsForHtmlUI(){
  ...
  document.getElementById('light-x').onmousemove = function(){g_lightPos[0] = this.value/100; renderAllShapes;}
  document.getElementById('light-y').onmousemove = function(){g_lightPos[1] = this.value/100; renderAllShapes;}
  document.getElementById('light-z').onmousemove = function(){g_lightPos[2] = this.value/100; renderAllShapes;}
...
gl.uniformMatrix4fv(u_GlobalRotateMatrix, false, globalRotMat.elements);
  ...
  if(g_animationActive) {
    ...
    l_lightPos[0]= g_lightPos[0] + 1.5*Math.cos(g_seconds);
    l_lightPos[2]= g_lightPos[2] +  1.5*Math.cos(g_seconds);
  ...
  if(g_normalOn){
    body.textureNum = [6,6,6,6,6,6];
    body.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    shell.textureNum = [6,6,6,6,6,6];
    shell.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    shell_top.textureNum = [6,6,6,6,6,6];
    shell_top.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    tail.textureNum = [6,6,6,6,6,6];
    tail.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    head.textureNum = [6,6,6,6,6,6];
    head.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    tongue.textureNum = [6,6,6,6,6,6];
    tongue.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legFL_1.textureNum = [6,6,6,6,6,6];
    legFL_1.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legFL_2.textureNum = [6,6,6,6,6,6];
    legFL_2.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legFL_3.textureNum = [6,6,6,6,6,6];
    legFL_3.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legFR_1.textureNum = [6,6,6,6,6,6];
    legFR_1.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legFR_2.textureNum = [6,6,6,6,6,6];
    legFR_2.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legFR_3.textureNum = [6,6,6,6,6,6];
    legFR_3.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legBL_1.textureNum = [6,6,6,6,6,6];
    legBL_1.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legBL_2.textureNum = [6,6,6,6,6,6];
    legBL_2.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legBL_3.textureNum = [6,6,6,6,6,6];
    legBL_3.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legBR_1.textureNum = [6,6,6,6,6,6];
    legBR_1.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legBR_2.textureNum = [6,6,6,6,6,6];
    legBR_2.textureNumberPlain = 6;
  }
  ...
  if(g_normalOn){
    legBR_3.textureNum = [6,6,6,6,6,6];
    legBR_3.textureNumberPlain = 6;
  }
  ...
  //world.drawSpace();
  var ocean = new Cube();
  ocean.color = [0.09, 0.09, 0.09, 1];
  if(g_normalOn){
    ocean.textureNum = [6,6,6,6,6,6];
    ocean.textureNumberPlain = 6;
  }
  ocean.matrix.translate(0, -0.75, 0);
  ocean.matrix.scale(50, .1, 50);
  ...
  sky.color = [.1, .1, .1, .6];
  if(g_normalOn){
    sky.textureNum = [6,6,6,6,6,6];
    sky.textureNumberPlain = 6;
  }
